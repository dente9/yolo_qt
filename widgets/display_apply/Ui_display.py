...
class Ui_mainlayout(object):
    def setupUi(self, mainlayout):
        ...
        mainlayout.resize(1000, 644)
        mainlayout.setMinimumSize(QSize(1000, 600))
        mainlayout.setMaximumSize(QSize(16677215, 16777215))
        mainlayout.setStyleSheet(u"QWidget#mainwigget {\n"
"    border-image: url(:/images/resource/images/bg.png);\n"
"}")
        self.verticalLayout_6 = QVBoxLayout(mainlayout)
        self.verticalLayout_6.setObjectName(u"verticalLayout_6")
        self.lb_title = QLabel(mainlayout)
        ...
        self.display = QLabel(mainlayout)
        ...
        self.tableWidget = QTableWidget(mainlayout)
        ...
        self.groupBox = QGroupBox(mainlayout)
        ...
        icon = QIcon()
        icon.addFile(u":/images/resource/images/model_select.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_model_select.setIcon(icon)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/images/resource/images/camera.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/images/resource/images/file.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_open_one_file.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/images/resource/images/dir.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btn_open_dir.setIcon(icon3)
        ...
        self.groupBox_2 = QGroupBox(mainlayout)
        ...
        self.groupBox_3 = QGroupBox(mainlayout)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/images/resource/images/clear.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/images/resource/images/save.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/images/resource/images/exit.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
    ...
    def retranslateUi(self, mainlayout):
        ...
        self.lb_title.setText(QCoreApplication.translate("mainlayout", u"\u7cfb\u7edf", None))
        self.display.setText(QCoreApplication.translate("mainlayout", u"display", None))
        ___qtablewidgetitem = self.tableWidget.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("mainlayout", u"\u5e8f\u53f7", None));
        ___qtablewidgetitem1 = self.tableWidget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("mainlayout", u"\u6587\u4ef6\u8def\u5f84", None));
        ___qtablewidgetitem2 = self.tableWidget.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("mainlayout", u"\u7c7b\u522b", None));
        ___qtablewidgetitem3 = self.tableWidget.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("mainlayout", u"\u7f6e\u4fe1\u5ea6", None));
        ___qtablewidgetitem4 = self.tableWidget.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("mainlayout", u"\u5750\u6807\u4f4d\u7f6e", None));
        self.groupBox.setTitle(QCoreApplication.translate("mainlayout", u"\u4fe1\u606f\u8f93\u5165", None))
        self.btn_model_select.setText(QCoreApplication.translate("mainlayout", u"\u6a21\u578b\u9009\u62e9", None))
        self.btn_camera.setText(QCoreApplication.translate("mainlayout", u"\u542f\u7528/\u5173\u95ed\u6444\u50cf\u5934", None))
        self.lb_cameracheck.setText(QCoreApplication.translate("mainlayout", u"\u6444\u50cf\u5934\u5df2\u5173\u95ed", None))
        self.btn_open_one_file.setText(QCoreApplication.translate("mainlayout", u"\u6253\u5f00\u6587\u4ef6", None))
        self.btn_open_dir.setText(QCoreApplication.translate("mainlayout", u"\u6253\u5f00\u6587\u4ef6\u5939", None))
        self.groupBox_2.setTitle(QCoreApplication.translate("mainlayout", u"\u68c0\u6d4b\u7ed3\u679c", None))
        self.label_14.setText(QCoreApplication.translate("mainlayout", u"ymin", None))
        self.label_6.setText(QCoreApplication.translate("mainlayout", u"\u76ee\u6807\u9009\u62e9", None))
        self.lb_ymax.setText(QCoreApplication.translate("mainlayout", u"0", None))
        self.label_7.setText(QCoreApplication.translate("mainlayout", u"\u7c7b\u578b", None))
        self.label_3.setText(QCoreApplication.translate("mainlayout", u"\u76ee\u6807\u6570\u91cf", None))
        self.lb_xmin.setText(QCoreApplication.translate("mainlayout", u"0", None))
        self.label_9.setText(QCoreApplication.translate("mainlayout", u"\u7f6e\u4fe1\u5ea6", None))
        self.label_11.setText(QCoreApplication.translate("mainlayout", u"\u76ee\u6807\u4f4d\u7f6e", None))
        self.label_47.setText(QCoreApplication.translate("mainlayout", u"ymax", None))
        self.label_2.setText(QCoreApplication.translate("mainlayout", u"\u7528\u65f6", None))
        self.lb_time.setText(QCoreApplication.translate("mainlayout", u"0s", None))
        self.lb_type.setText(QCoreApplication.translate("mainlayout", u"type", None))
        self.label_12.setText(QCoreApplication.translate("mainlayout", u"xmin", None))
        self.label_29.setText(QCoreApplication.translate("mainlayout", u"xmax", None))
        self.lb_ymin.setText(QCoreApplication.translate("mainlayout", u"0", None))
        self.lb_xmax.setText(QCoreApplication.translate("mainlayout", u"0", None))
        self.lb_num.setText(QCoreApplication.translate("mainlayout", u"0", None))
        self.lb_conf.setText(QCoreApplication.translate("mainlayout", u"0%", None))
        self.groupBox_3.setTitle(QCoreApplication.translate("mainlayout", u"\u64cd\u4f5c", None))
        self.btn_clear.setText(QCoreApplication.translate("mainlayout", u"\u6e05\u9664", None))
        self.btn_save.setText(QCoreApplication.translate("mainlayout", u"\u4fdd\u5b58\u5386\u53f2\u8bb0\u5f55", None))
        self.btn_exit.setText(QCoreApplication.translate("mainlayout", u"\u9000\u51fa", None))
    # retranslateUi
